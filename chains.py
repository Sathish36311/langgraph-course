...
first_responder = actor_prompt_template.partial(first_instruction="Provide a detailed ~100 word answer.") | llm.bind_tools(tools=[AnswerQuestion], tool_choice="AnswerQuestion")
